...
if __name__=="__main__":
    ...
    for indx in np.random.permutation(wsi_dim_arr.shape[0]):
        ...
        coord_map[(coord_arr_scaled_y, coord_arr_scaled_x,0)] = (coord_arr[:,0]/tile_size*patch_size_lv0).astype(int)
        coord_map[(coord_arr_scaled_y, coord_arr_scaled_x,1)] = (coord_arr[:,1]/tile_size*patch_size_lv0).astype(int)
